...
export const PhotoEmptyState = ({ show, onChange }: Props) => {
  ...
  return (
    <div className="w-full relative">
      <div className="opacity-10 md:opacity-100 -mt-10 md:mt-0 absolute right-0 md:right-0 top-6 md:-top-6 z-[-1]">
      ...
      <div className="invisible md:visible absolute right-0 md:right-8 top-6 md:-top-6 z-[-1]">
      ...
      <div className="invisible md:visible absolute right-0 md:right-20 top-6 md:-top-6 z-[-1]">
