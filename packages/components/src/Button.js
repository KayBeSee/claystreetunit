...
let colors = {
  ...
  gray: [
    'bg-sicard-gold-100 text-sicard-gold-700 hover:bg-sicard-gold-200 hover:text-sicard-gold-900 focus:ring-sicard-gold-500',
    'text-sicard-gold-300 group-hover:text-sicard-gold-400',
  ],
};
